...
<footer class="footer">
    <div class="footer-inner">
        <div class="copyright pull-left">
            <a href="http://blog-ledaishu.1d35.starter-us-east-1.openshiftapps.com/" title="乐呆鼠"><strong>乐呆鼠</strong></a>版权所有！ &copy; <?php echo date('Y'); ?> <a href="<?php bloginfo('url'); ?>"><?php bloginfo('name'); ?></a>
        </div>
